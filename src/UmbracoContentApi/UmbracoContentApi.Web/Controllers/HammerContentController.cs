...
namespace UmbracoContentApi.Web.Controllers
{
    ...
    public class HammerContentController : UmbracoApiController
    {
        private readonly Lazy<IContentResolver> _contentResolver;
        private readonly string _excludeDoctypes;
   

        public HammerContentController(
            Lazy<IContentResolver> contentResolver)
        {
            _contentResolver = contentResolver;
            _excludeDoctypes = ConfigurationManager.AppSettings["HammerExcludeDoctypes"] != null ? ConfigurationManager.AppSettings["HammerExcludeDoctypes"] : "";
